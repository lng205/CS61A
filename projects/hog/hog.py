...
def tail_points(opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    d = opponent_score // 10 % 10 - opponent_score % 10
    return d < 0 and 1 - 2 * d or 1 + 2 * d
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    return num_rolls == 0 and tail_points(opponent_score) or roll_dice(num_rolls, dice)
    # END PROBLEM 3
